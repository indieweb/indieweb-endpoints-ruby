describe IndieWeb::Endpoints::Parsers::AuthorizationEndpointParser do
  ...
  context 'when given a URL that does not advertise an authorization endpoint' do
    before do
  ...
  context 'when given a URL advertising its authorization endpoint in an HTTP Link header' do
  ...
  context 'when given a URL advertising its authorization endpoint in an HTML `link` element' do
  ...
  context 'when given a URL advertising multiple authorization endpoints' do
