describe IndieWeb::Endpoints::Parsers::TokenEndpointParser do
  ...
  context 'when given a URL that does not advertise an token endpoint' do
    before do
  ...
  context 'when given a URL advertising its token endpoint in an HTTP Link header' do
  ...
  context 'when given a URL advertising its token endpoint in an HTML `link` element' do
  ...
  context 'when given a URL advertising multiple token endpoints' do
