...
indieweb-endpoints-ruby is developed using Ruby 2.6.9 and is additionally tested against Ruby 2.7 and 3.0 using [GitHub Actions](https://github.com/indieweb/indieweb-endpoints-ruby/actions).
