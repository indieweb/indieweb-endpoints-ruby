...
indieweb-endpoints-ruby is developed using Ruby 2.4.9 and is additionally tested against Ruby 2.5 and 2.6 using [Travis CI](https://travis-ci.com/indieweb/indieweb-endpoints-ruby).
