...
Before making changes to indieweb-endpoints-ruby, you'll want to install Ruby 2.7.8. It's recommended that you use a Ruby version managment tool like [rbenv](https://github.com/rbenv/rbenv), [chruby](https://github.com/postmodern/chruby), or [rvm](https://github.com/rvm/rvm). Once you've installed Ruby 2.7.8 using your method of choice, install the project's gems by running:
